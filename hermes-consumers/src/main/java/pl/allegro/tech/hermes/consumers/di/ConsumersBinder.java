...
import pl.allegro.tech.hermes.consumers.consumer.sender.http.BroadCastRequestsCreatorFactory;
import pl.allegro.tech.hermes.consumers.consumer.sender.http.DefaultBroadCastRequestsCreatorFactory;
...
public class ConsumersBinder extends AbstractBinder {
    ...
    protected void configure() {
        ...
        bind(DefaultBroadCastRequestsCreatorFactory.class).to(BroadCastRequestsCreatorFactory.class).in(Singleton.class);
